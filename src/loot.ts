...
export function createChest(source:LootSource,x:number,y:number):LootChest{
  const table=LOOT_TABLES[source],gilded=Math.random()<table.gildedChance,boost=gilded?1.6:1;
