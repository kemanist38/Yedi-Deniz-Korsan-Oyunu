...
ui('digPrompt').onclick=startDig;ui('closeCannonShop').onclick=closeCannonShop;ui('closeEquipShop').onclick=closeEquipShop;ui('equipShopOverlay').addEventListener('pointerdown',e=>{if(e.target===ui('equipShopOverlay'))closeEquipShop();});ui('cannonShopOverlay').addEventListener('pointerdown',e=>{if(e.target===ui('cannonShopOverlay'))closeCannonShop();});
