...
{id:'phantom',level:1,name:'Hayalet Kadırga',english:'The Phantom Galleon',asset:'/assets/elite-phantom-v1.webp'},
{id:'magma',level:2,name:'Volkanik Dreadnought',english:'Volcanic Dreadnought',asset:'/assets/elite-magma-v1.webp'},
{id:'glacial',level:3,name:'Buzul Tiranı',english:'Glacial Tyrant',asset:'/assets/elite-glacial-v1.webp'},
{id:'kraken',level:4,name:"Kraken'in Gazabı",english:"Kraken's Embrace",asset:'/assets/elite-kraken-v1.webp'},
{id:'ironclad',level:5,name:'Buharlı Zırhlı',english:'Steampunk Ironclad',asset:'/assets/elite-ironclad-v1.webp'},
{id:'crimson',level:6,name:'Kanlı Ay Korveti',english:'Crimson Moon Corsair',asset:'/assets/elite-crimson-v1.webp'},
{id:'atlantean',level:7,name:'Kadim Atlantis Muhafızı',english:'Atlantean Sentry',asset:'/assets/elite-atlantean-v1.webp'},
{id:'bone',level:8,name:'Kemik Biçici',english:'Bone Harvester',asset:'/assets/elite-bone-v1.webp'},
{id:'tempest',level:9,name:'Fırtına Habercisi',english:'Tempest Harbinger',asset:'/assets/elite-tempest-v1.webp'},
{id:'plague',level:10,name:'Kraliyet Sancaktarı',english:'Royal Standard-Bearer',asset:'/assets/elite-plague-v1.webp'},
{id:'sovereign',level:11,name:'Yeşim Ejderha',english:'Jade Dragon',asset:'/assets/elite-sovereign-v1.webp'},
{id:'shadow',level:12,name:'Ragnarok Yıkıcısı',english:'Ragnarok Destroyer',asset:'/assets/elite-shadow-v1.webp'},
{id:'jade',level:13,name:'Hiçlik Hükümdarı',english:'Void Monarch',asset:'/assets/elite-jade-v1.webp'},
{id:'ragnarok',level:14,name:'Mercan Koruyucusu',english:'Coral Guardian',asset:'/assets/elite-ragnarok-v1.webp'},
{id:'void',level:15,name:'Kum Gezgini',english:'Sand Wanderer',asset:'/assets/elite-void-v1.webp'}
];
