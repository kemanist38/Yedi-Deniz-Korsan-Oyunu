...
{id:'magma',level:2,name:'Magma Leviathanı',english:'Volcanic Dreadnought',role:'Yüksek Hasar / DoT',passive:'%10 top hasarı; vuruşlarda %20 ihtimalle 3 saniye yakma',ability:'Lav Püskürtme',abilityDescription:'360 derece ateş dalgasıyla çevredeki düşmanları yakar.',asset:'/assets/elite-magma-v1.webp'},
...
{id:'atlantean',level:7,name:'Kadim Atlantis Muhafızı',english:'Atlantean Sentry',role:'Kalkan / Koruma',passive:'%50 daha hızlı kalkan dolumu',ability:'Koruma Kubbesi',abilityDescription:'6 saniye kendisini ve filo arkadaşlarını menzilli hasardan korur.',asset:'/assets/elite-atlantean-v1.webp'},
...
{id:'plague',level:10,name:'Zümrüt Simyacı',english:'Emerald Plague',role:'Zayıflatıcı',passive:'Hedefin tamir ve iyileştirmesini %50 azaltır',ability:'Zehirli Sis',abilityDescription:'10 saniyelik zehir bulutu düşmanları yavaşlatır ve sürekli hasar verir.',asset:'/assets/elite-plague-v1.webp'},
{id:'sovereign',level:11,name:'Kraliyet Sancaktarı',english:'Imperial Sovereign',role:'Filo Lideri',passive:'%20 daha fazla Altın, İnci ve ganimet',ability:"Kralın Emri",abilityDescription:'Yakındaki filo üyelerine 10 saniye %15 top hasarı verir.',asset:'/assets/elite-sovereign-v1.webp'},
{id:'shadow',level:12,name:'Gece Gölgesi',english:'Shadow Corsair',role:'Suikastçı',passive:'Yaklaşılana kadar düşman mini haritasında görünmez',ability:'Gölgeden Vuruş',abilityDescription:'Görünmezlikten veya sisten ilk saldırı %100 kritik vurur.',asset:'/assets/elite-shadow-v1.webp'},
{id:'jade',level:13,name:'Yeşim Ejderha',english:'Jade Junk',role:'Seri Atış / Çeviklik',passive:'%15 hızlı dolum ve üstün manevra',ability:'Havai Fişek Yağmuru',abilityDescription:'Özel roketler hedefin isabetini 4 saniyeliğine bozar.',asset:'/assets/elite-jade-v1.webp'},
{id:'ragnarok',level:14,name:'Ragnarok Yıkıcısı',english:"Norse Jarl's Longship",role:'Berserker',passive:'Kaybedilen her %10 Can için %4 hasar',ability:'Valhalla Çağrısı',abilityDescription:'Son %1 Canda 4 saniye batmaz ve azami ateş gücüne ulaşır.',asset:'/assets/elite-ragnarok-v1.webp'},
