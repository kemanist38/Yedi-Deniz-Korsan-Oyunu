...
// ENVANTER → DONANIM bölümünden gemideki yuvaya takılır. Atlas: public/assets/equip-atlas-v1.webp (4 sütun × 3 satır).
...
export const EQUIP_ATLAS='/assets/equip-atlas-v1.webp';
